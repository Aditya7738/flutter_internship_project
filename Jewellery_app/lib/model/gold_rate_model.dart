...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      goldPricing: json["gold_pricing"] == null
          ? null
          : GoldPricing.fromJson(json["gold_pricing"]),
      silverPricing: json["silver_pricing"] == null
          ? null
          : SilverPricing.fromJson(json["silver_pricing"]),
      platinumPricing: json["platinum_pricing"] == null
          ? null
          : PlatinumPricing.fromJson(json["platinum_pricing"]),
      labourPricing: json["labour_pricing"] == null
          ? null
          : LabourPricing.fromJson(json["labour_pricing"]),
      diamondPricing: Map.from(json["diamond_pricing"]).map((k, v) =>
          MapEntry<String, List<Pricing>>(
              k,
              v == null
                  ? []
                  : List<Pricing>.from(v!.map((x) => Pricing.fromJson(x))))),
      gemstonePricing: Map.from(json["gemstone_pricing"]).map((k, v) =>
          MapEntry<String, List<GemstonePricing>>(
              k,
              v == null
                  ? []
                  : List<GemstonePricing>.from(
                      v!.map((x) => GemstonePricing.fromJson(x))))),
      additionalPricing: json["additional_pricing"] == null
          ? null
          : AdditionalPricing.fromJson(json["additional_pricing"]),
      lastUpdated: json["last_updated"],
      marginPricing: Map.from(json["margin_pricing"]).map((k, v) =>
          MapEntry<String, List<Pricing>>(
              k,
              v == null
                  ? []
  ...
  Map<String, dynamic> toJson() => {
        ...
        "diamond_pricing": Map.from(diamondPricing).map((k, v) =>
            MapEntry<String, dynamic>(k, v.map((x) => x?.toJson()).toList())),
        "gemstone_pricing": Map.from(gemstonePricing).map((k, v) =>
            MapEntry<String, dynamic>(k, v.map((x) => x?.toJson()).toList())),
        "additional_pricing": additionalPricing?.toJson(),
        "last_updated": lastUpdated,
        "margin_pricing": Map.from(marginPricing).map((k, v) =>
            MapEntry<String, dynamic>(k, v.map((x) => x?.toJson()).toList())),
      };
}
...
class AdditionalPricing {
  ...
  factory AdditionalPricing.fromJson(Map<String, dynamic> json) {
    return AdditionalPricing(
      hallmark: json["hallmark"] == null
          ? null
          : Certificate.fromJson(json["hallmark"]),
      certificate: json["certificate"] == null
          ? null
          : Certificate.fromJson(json["certificate"]),
      rhodium: json["rhodium"] == null
          ? null
          : Certificate.fromJson(json["rhodium"]),
    );
  }
...
class Pricing {
  ...
  factory Pricing.fromJson(Map<String, dynamic> json) {
    return Pricing(
      id: json["id"],
      clarities: json["clarities"] == null
          ? []
          : List<Clarity>.from(
              json["clarities"]!.map((x) => Clarity.fromJson(x))),
      colors: json["colors"] == null
          ? []
          : List<Clarity>.from(json["colors"]!.map((x) => Clarity.fromJson(x))),
      shapes: json["shapes"] == null
          ? []
          : List<Clarity>.from(json["shapes"]!.map((x) => Clarity.fromJson(x))),
      sieves: json["sieves"] == null
          ? []
          : List<Clarity>.from(json["sieves"]!.map((x) => Clarity.fromJson(x))),
      sieveFrom: json["sieve_from"],
      sieveTo: json["sieve_to"],
      sieveType: json["sieve_type"],
      cuts: json["cuts"] == null
          ? []
          : List<Clarity>.from(json["cuts"]!.map((x) => Clarity.fromJson(x))),
      types: json["types"] == null
          ? []
          : List<Clarity>.from(json["types"]!.map((x) => Clarity.fromJson(x))),
      rate: json["rate"],
      title: json["title"],
    );
  }
  ...
  factory GemstonePricing.fromJson(Map<String, dynamic> json) {
    return GemstonePricing(
      ...
      qualities: json["qualities"] == null
          ? []
          : List<Clarity>.from(
              json["qualities"]!.map((x) => Clarity.fromJson(x))),
      types: json["types"] == null
          ? []
          : List<Clarity>.from(json["types"]!.map((x) => Clarity.fromJson(x))),
      shapes: json["shapes"] == null
      ...
      sizes: json["sizes"] == null
          ? []
          : List<Clarity>.from(json["sizes"]!.map((x) => Clarity.fromJson(x))),
      rate: json["rate"],
    );
  }
...
class GoldPricingInr {
  ...
  factory GoldPricingInr.fromJson(Map<String, dynamic> json) {
    return GoldPricingInr(
      ...
      automatic: json["automatic"] == null
          ? null
          : PurpleAutomatic.fromJson(json["automatic"]),
      manual: Map.from(json["manual"])
          .map((k, v) => MapEntry<String, Manual>(k, Manual.fromJson(v))),
      enabledPurities: Map.from(json["enabled_purities"])
  ...
  Map<String, dynamic> toJson() => {
        ...
        "manual": Map.from(manual)
            .map((k, v) => MapEntry<String, dynamic>(k, v?.toJson())),
        "enabled_purities": Map.from(enabledPurities)
...
class LabourPricing {
  ...
  factory LabourPricing.fromJson(Map<String, dynamic> json) {
    return LabourPricing(
      inr: json["INR"] == null
          ? []
          : List<InrElement>.from(
              json["INR"]!.map((x) => InrElement.fromJson(x))),
    );
  }
  ...
  factory InrElement.fromJson(Map<String, dynamic> json) {
    return InrElement(
      ...
      collections: json["collections"] == null
          ? []
          : List<Category>.from(
              json["collections"]!.map((x) => Category.fromJson(x))),
...
class PlatinumPricing {
  ...
  factory PlatinumPricing.fromJson(Map<String, dynamic> json) {
    return PlatinumPricing(
      inr:
          json["INR"] == null ? null : PlatinumPricingInr.fromJson(json["INR"]),
      from: json["from"],
      type: json["type"],
    );
  }
...
class PlatinumPricingInr {
  ...
  factory PlatinumPricingInr.fromJson(Map<String, dynamic> json) {
    return PlatinumPricingInr(
      inrDefault: json["default"],
      automatic: Map.from(json["automatic"]).map((k, v) =>
          MapEntry<String, AutomaticValue>(k, AutomaticValue.fromJson(v))),
      manual: Map.from(json["manual"])
          .map((k, v) => MapEntry<String, Manual>(k, Manual.fromJson(v))),
      enabledPurities: json["enabled_purities"] == null
          ? []
          : List<dynamic>.from(json["enabled_purities"]!.map((x) => x)),
    );
  }

  Map<String, dynamic> toJson() => {
        "default": inrDefault,
        "automatic": Map.from(automatic)
            .map((k, v) => MapEntry<String, dynamic>(k, v?.toJson())),
        "manual": Map.from(manual)
            .map((k, v) => MapEntry<String, dynamic>(k, v?.toJson())),
...
class SilverPricingInr {
  ...
  factory SilverPricingInr.fromJson(Map<String, dynamic> json) {
    return SilverPricingInr(
      ...
      automatic: json["automatic"] == null
          ? null
          : FluffyAutomatic.fromJson(json["automatic"]),
      manual: Map.from(json["manual"])
          .map((k, v) => MapEntry<String, Manual>(k, Manual.fromJson(v))),
      enabledPurities: Map.from(json["enabled_purities"])
          .map((k, v) => MapEntry<String, bool>(k, v)),
