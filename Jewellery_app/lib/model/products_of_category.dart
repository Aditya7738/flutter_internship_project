class ProductOfCategoryModel {
    ...
    factory ProductOfCategoryModel.fromJson(Map<String, dynamic> json){ 
        return ProductOfCategoryModel(
            ...
            subcategory: json["subcategory"] == null ? [] : List<SubcategoryElement>.from(json["subcategory"]!.map((x) => SubcategoryElement.fromJson(x))),
            collections: json["collections"] == null ? [] : List<SubcategoryElement>.from(json["collections"]!.map((x) => SubcategoryElement.fromJson(x))),
...
class FluffyValue {
    ...
    factory FluffyValue.fromJson(Map<String, dynamic> json){ 
        return FluffyValue(
            ...
            extracharges: Map.from(json["extracharges"]).map((k, v) => MapEntry<String, Extracharge>(k, Extracharge.fromJson(v))),
            ...
            customize: json["customize"] == null ? null : Customize.fromJson(json["customize"]),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "extracharges": Map.from(extracharges).map((k, v) => MapEntry<String, dynamic>(k, v?.toJson())),
...
class Metal {
    ...
    factory Metal.fromJson(Map<String, dynamic> json){ 
        return Metal(
            ...
            silver: json["silver"] == null ? null : MetalSilver.fromJson(json["silver"]),
            platinum: json["platinum"] == null ? null : MetalPlatinum.fromJson(json["platinum"]),
        );
    }
